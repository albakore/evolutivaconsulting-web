	...
	return (
	  	<Seccion id="contacto">
				...
				<HStack gap={0} position={'relative'} overflow={'hidden'}  >
					<Box pointerEvents={'none'} borderRadius={'3px'} w='100%' h={'100%'} top={0} left={0} zIndex={200} position={'absolute'} background={'linear-gradient(to right, #ffff, transparent, transparent, #ffff)'} boxShadow='0 0 15px 15px white inset'></Box>
